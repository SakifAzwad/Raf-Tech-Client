...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="py-2 bg-white dark:bg-col1">
            ...
            {user ? (
              <>
                ...
                <div className="md:flex  md:space-x-3">
                  ...
                  <h1 className="flex lg:items-center text-col1 dark:text-col4">
                    {user.displayName}
                  </h1>
                </div>
              </>
            ...
            <div className="space-x-3 pr-2 md:pr-8">
              {user ? (
                <>
                  <button
                    onClick={hanlogout}
                    className="btn bg-col3 text-col4 border-0 hover:bg-col4 hover:text-col1"
                  >
                    Log Out
                  </button>
                </>
        ...
        <div className="dark:text-col4 text-col1 text-xl py-2 border-t-2 border-col2">
